...
//第二个参数为自己独有的accessKeyid，第三个参数为自己独有的accessKeySecret
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou",
                "LTAI5tQnM7MgWQXDFJ38xT7b","IX2PMk3tpIJREclerx1XQKLeog4LxE");
        ...
        request.putQueryParameter("SignName", "黄陈鸿的博客");//短信签名
        request.putQueryParameter("TemplateCode", "SMS_263415261");
